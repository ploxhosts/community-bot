...
class BadWords{
     ...
     *
     */
    addBadWord = async (badWord: string, guild_id: string) => {
        try {
    ...
    removeBadWord = async (badWord: string, guild_id: string) => {
        try {
            return await postgres.query(
     ...
     *
     */
    getAllBadWords = async (guild_id: string) => {
        try {
            return await postgres.query(
