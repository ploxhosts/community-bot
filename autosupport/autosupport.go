...
func autoRespond(allText string, imageText string) string {
	...
	var discordBotHosting = map[string]string{
		...
		"make a ticket":                    "You can create a ticket at: https://support.plox.host/en/tickets/create/step1",
		"-new":                             "You can create a ticket at: https://support.plox.host/en/tickets/create/step1",
